...
| Método | RGB->gris (s) | Sobel (s) | Total (s) | % blancos | Unidades | Speed-up vs secuencial | Performance (%) |
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: |
| secuencial | 0.138310733 | 0.382343170 | 0.520653903 | 0.281777778 | 1 | 1.000000 | 100.00 |
| numpy | 0.034693624 | 0.006614383 | 0.041308007 | 0.281777778 | 1 | 12.604188 | 1260.42 |
| numba_cpu | 0.010843878 | 0.000573319 | 0.011417198 | 0.281777778 | 4 | 45.602599 | 1140.06 |
| numba_gpu | 0.001167969 | 0.000624656 | 0.001792625 | 0.281777778 | 1 comp. GPU | 290.442174 | 29044.22 |
| pytorch_cpu | 0.002649721 | 0.006761589 | 0.009411310 | 0.281777778 | 4 | 55.322150 | 1383.05 |
| pytorch_gpu | 0.010117973 | 0.006472537 | 0.016590509 | 0.281777778 | 1 comp. GPU | 31.382636 | 3138.26 |

### 3.2 Imagen 1500x1500

| Método | RGB->gris (s) | Sobel (s) | Total (s) | % blancos | Unidades | Speed-up vs secuencial | Performance (%) |
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: |
| secuencial | 0.538026730 | 1.499926087 | 2.037952817 | 0.059955556 | 1 | 1.000000 | 100.00 |
| numpy | 0.113359447 | 0.067603042 | 0.180962489 | 0.059955556 | 1 | 11.261742 | 1126.17 |
| numba_cpu | 0.004120866 | 0.005007883 | 0.009128749 | 0.059955556 | 4 | 223.245575 | 5581.14 |
| numba_gpu | 0.002681795 | 0.002221041 | 0.004902836 | 0.059955556 | 1 comp. GPU | 415.668160 | 41566.82 |
| pytorch_cpu | 0.021680436 | 0.037033428 | 0.058713864 | 0.059955556 | 4 | 34.709908 | 867.75 |
| pytorch_gpu | 0.004482590 | 0.002693912 | 0.007176502 | 0.059955556 | 1 comp. GPU | 283.975789 | 28397.58 |

### 3.3 Imagen 3000x3000

| Método | RGB->gris (s) | Sobel (s) | Total (s) | % blancos | Unidades | Speed-up vs secuencial | Performance (%) |
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: |
| secuencial | 2.205622351 | 6.289663254 | 8.495285605 | 0.001366667 | 1 | 1.000000 | 100.00 |
| numpy | 0.738434547 | 0.806570722 | 1.545005269 | 0.001366667 | 1 | 5.498548 | 549.85 |
| numba_cpu | 0.008683773 | 0.011001686 | 0.019685458 | 0.001366667 | 4 | 431.551331 | 10788.78 |
| numba_gpu | 0.007701786 | 0.007390242 | 0.015092028 | 0.001366667 | 1 comp. GPU | 562.898876 | 56289.89 |
| pytorch_cpu | 0.059138226 | 0.161758470 | 0.220896696 | 0.001366667 | 4 | 38.458183 | 961.45 |
| pytorch_gpu | 0.016800519 | 0.009445662 | 0.026246180 | 0.001366667 | 1 comp. GPU | 323.677031 | 32367.70 |

### 3.4 Imagen 6000x6000

| Método | RGB->gris (s) | Sobel (s) | Total (s) | % blancos | Unidades | Speed-up vs secuencial | Performance (%) |
| --- | ---: | ---: | ---: | ---: | --- | ---: | ---: |
| secuencial | 9.001387958 | 24.281427828 | 33.282815786 | 0.000000000 | 1 | 1.000000 | 100.00 |
| numpy | 2.913070440 | 4.490567513 | 7.403637953 | 0.000000000 | 1 | 4.495468 | 449.55 |
| numba_cpu | 0.028065790 | 0.032870512 | 0.060936302 | 0.000000000 | 4 | 546.190279 | 13654.76 |
| numba_gpu | 0.022455198 | 0.026138397 | 0.048593595 | 0.000000000 | 1 comp. GPU | 684.921866 | 68492.19 |
| pytorch_cpu | 0.222153528 | 0.606586414 | 0.828739942 | 0.000000000 | 4 | 40.160748 | 1004.02 |
| pytorch_gpu | 0.057195118 | 0.032686961 | 0.089882078 | 0.000000000 | 1 comp. GPU | 370.294240 | 37029.42 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| 750x750 | 0.011417198 | 0.000956392 | 11.937781x | 0.001792625 | 6.368983x |
| 1500x1500 | 0.009128749 | 0.002765703 | 3.300698x | 0.004902836 | 1.861932x |
| 3000x3000 | 0.019685458 | 0.009050032 | 2.175181x | 0.015092028 | 1.304361x |
| 6000x6000 | 0.060936302 | 0.031016600 | 1.964635x | 0.048593595 | 1.253999x |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 750x750 | 0.000662192 | 0.000174041 | 0.000836233 | 0.000956392 | 0.001792625 | 290.442174x | 6.368983x |
| 1500x1500 | 0.001496865 | 0.000640268 | 0.002137133 | 0.002765703 | 0.004902836 | 415.668160x | 1.861932x |
| 3000x3000 | 0.004192532 | 0.001849464 | 0.006041996 | 0.009050032 | 0.015092028 | 562.898876x | 1.304361x |
| 6000x6000 | 0.010809212 | 0.006767782 | 0.017576994 | 0.031016600 | 0.048593595 | 684.921866x | 1.253999x |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| 750x750 | 0.009411310 | 0.015394777 | 0.611331x | 0.016590509 | 0.567271x |
| 1500x1500 | 0.058713864 | 0.004065700 | 14.441268x | 0.007176502 | 8.181404x |
| 3000x3000 | 0.220896696 | 0.014966240 | 14.759665x | 0.026246180 | 8.416337x |
| 6000x6000 | 0.828739942 | 0.049590521 | 16.711660x | 0.089882078 | 9.220302x |
...
| Tamaño | Transferencia CPU->GPU (s) | Transferencia GPU->CPU (s) | Transferencia total (s) | Cómputo GPU (s) | GPU con transferencias (s) | Speed-up vs secuencial con transferencias | Speed-up vs PyTorch CPU con transferencias |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 750x750 | 0.000849445 | 0.000346288 | 0.001195733 | 0.015394777 | 0.016590509 | 31.382636x | 0.567271x |
| 1500x1500 | 0.002550422 | 0.000560380 | 0.003110802 | 0.004065700 | 0.007176502 | 283.975789x | 8.181404x |
| 3000x3000 | 0.009720037 | 0.001559904 | 0.011279941 | 0.014966240 | 0.026246180 | 323.677031x | 8.416337x |
| 6000x6000 | 0.032163902 | 0.008127655 | 0.040291557 | 0.049590521 | 0.089882078 | 370.294240x | 9.220302x |
...
Los siguientes comentarios marcan dónde conviene pegar las imágenes en Obsidian. Se agrupan por tamaño para mostrar que las salidas son visualmente comparables entre métodos. No es necesario incluir todas en la versión final si el informe queda demasiado extenso; alcanza con una resolución representativa y, si se desea, la de 6000x6000 para acompañar la aclaración del porcentaje de blancos.

#### Imagen 750x750

<!-- PEGAR ACÁ imagen original 750x750: ../../../tp3.3/imagenes/IMG_0358_750x750.jpg -->
<!-- PEGAR ACÁ salida Sobel secuencial 750x750: ../../../tp3.1/salidas/sobel_secuencial_750.png -->
<!-- PEGAR ACÁ salida Sobel NumPy 750x750: ../../../tp3.1/salidas/sobel_numpy_750.png -->
<!-- PEGAR ACÁ salida Sobel Numba CPU 750x750: ../../../tp3.1/salidas/sobel_numba_cpu_750.png -->
<!-- PEGAR ACÁ salida Sobel Numba GPU 750x750: ../../../tp3.2/salidas/sobel_numba_gpu_750.png -->
<!-- PEGAR ACÁ salida Sobel PyTorch CPU 750x750: ../../../tp3.3/salidas/sobel_pytorch_cpu_750.png -->
<!-- PEGAR ACÁ salida Sobel PyTorch GPU 750x750: ../../../tp3.3/salidas/sobel_pytorch_gpu_750.png -->

#### Imagen **1500x1500**

<!-- PEGAR ACÁ imagen original 1500x1500: ../../../tp3.3/imagenes/IMG_0358_1500x1500.jpg -->
<!-- PEGAR ACÁ salida Sobel secuencial 1500x1500: ../../../tp3.1/salidas/sobel_secuencial_1500.png -->
<!-- PEGAR ACÁ salida Sobel NumPy 1500x1500: ../../../tp3.1/salidas/sobel_numpy_1500.png -->
<!-- PEGAR ACÁ salida Sobel Numba CPU 1500x1500: ../../../tp3.1/salidas/sobel_numba_cpu_1500.png -->
<!-- PEGAR ACÁ salida Sobel Numba GPU 1500x1500: ../../../tp3.2/salidas/sobel_numba_gpu_1500.png -->
<!-- PEGAR ACÁ salida Sobel PyTorch CPU 1500x1500: ../../../tp3.3/salidas/sobel_pytorch_cpu_1500.png -->
<!-- PEGAR ACÁ salida Sobel PyTorch GPU 1500x1500: ../../../tp3.3/salidas/sobel_pytorch_gpu_1500.png -->

#### Imagen 3000x3000

<!-- PEGAR ACÁ imagen original 3000x3000: ../../../tp3.3/imagenes/IMG_0358_3000x3000.jpg -->
<!-- PEGAR ACÁ salida Sobel secuencial 3000x3000: ../../../tp3.1/salidas/sobel_secuencial_3000.png -->
<!-- PEGAR ACÁ salida Sobel NumPy 3000x3000: ../../../tp3.1/salidas/sobel_numpy_3000.png -->
<!-- PEGAR ACÁ salida Sobel Numba CPU 3000x3000: ../../../tp3.1/salidas/sobel_numba_cpu_3000.png -->
<!-- PEGAR ACÁ salida Sobel Numba GPU 3000x3000: ../../../tp3.2/salidas/sobel_numba_gpu_3000.png -->
<!-- PEGAR ACÁ salida Sobel PyTorch CPU 3000x3000: ../../../tp3.3/salidas/sobel_pytorch_cpu_3000.png -->
<!-- PEGAR ACÁ salida Sobel PyTorch GPU 3000x3000: ../../../tp3.3/salidas/sobel_pytorch_gpu_3000.png -->

#### Imagen 6000x6000

<!-- PEGAR ACÁ imagen original 6000x6000: ../../../tp3.3/imagenes/IMG_0358_6000x6000.jpg -->
<!-- PEGAR ACÁ salida Sobel secuencial 6000x6000: ../../../tp3.1/salidas/sobel_secuencial_6000.png -->
<!-- PEGAR ACÁ salida Sobel NumPy 6000x6000: ../../../tp3.1/salidas/sobel_numpy_6000.png -->
<!-- PEGAR ACÁ salida Sobel Numba CPU 6000x6000: ../../../tp3.1/salidas/sobel_numba_cpu_6000.png -->
<!-- PEGAR ACÁ salida Sobel Numba GPU 6000x6000: ../../../tp3.2/salidas/sobel_numba_gpu_6000.png -->
<!-- PEGAR ACÁ salida Sobel PyTorch CPU 6000x6000: ../../../tp3.3/salidas/sobel_pytorch_cpu_6000.png -->
<!-- PEGAR ACÁ salida Sobel PyTorch GPU 6000x6000: ../../../tp3.3/salidas/sobel_pytorch_gpu_6000.png -->
